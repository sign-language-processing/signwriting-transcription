...
def upload_line(new_row):
  ...
  """
    ...
    if os.path.exists("signwriting_transcription/pose_to_signwriting/joeynmt_pose/token.json"):
        creds = Credentials.from_authorized_user_file("signwriting_transcription/pose_to_signwriting/joeynmt_pose/token.json", SCOPES)
    ...
    if not creds or not creds.valid:
        ...
        with open("signwriting_transcription/pose_to_signwriting/joeynmt_pose/token.json", "w") as token:
